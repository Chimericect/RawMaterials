...
require 'src/states/entity/PlayerDuckState'
...
require 'src/states/entity/fly/FlyChasingState'
require 'src/states/entity/fly/FlyIdleState'
...
gTextures = {
    ...
    ['background4b'] = love.graphics.newImage('graphics/background4b.png'),
    ['green-alien'] = love.graphics.newImage('graphics/miner.png'),
	...
	['crystals'] = love.graphics.newImage('graphics/CrystalTiles.png'),
...
gFrames = {
    ...
    ['background4b'] = GenerateQuads(gTextures['background4b'], 256, 128),
	...
	['crystals'] = GenerateQuads(gTextures['crystals'], 16, 16),
	['ladders'] = GenerateQuads(gTextures['ladders'], 16, 16),
	['crates'] = GenerateQuads(gTextures['crates'], 16, 16)
}
